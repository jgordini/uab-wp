 ...
 * Slug: uab-wp/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'uab-wp' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'uab-wp' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'uab-wp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'uab-wp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'uab-wp' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
