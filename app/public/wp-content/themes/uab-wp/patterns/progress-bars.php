...
<p><?php echo esc_html__( 'Item #1', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '100%', 'uab-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #2', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '90%', 'uab-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #3', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '80%', 'uab-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #4', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '70%', 'uab-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #5', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '60%', 'uab-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #6', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '50%', 'uab-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
