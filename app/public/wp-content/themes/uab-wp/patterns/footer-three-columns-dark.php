 ...
 * Slug: uab-wp/footer-three-columns-dark
 * Categories: footer
...
<!-- wp:paragraph -->
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'uab-wp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'uab-wp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'uab-wp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'uab-wp' ); ?></a></p>
<!-- /wp:paragraph -->
